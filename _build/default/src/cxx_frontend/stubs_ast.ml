...
module type S = sig
  ...
  module Builder : sig
    ...
    module Decl : sig
      ...
      val is_implicit_get : t -> bool
      val is_implicit_set : t -> bool -> unit
      val of_message : rw message_t -> t
      val to_message : t -> rw message_t
      val to_reader : t -> struct_t reader_t
      val init_root : ?message_size:int -> unit -> t
...
module MakeRPC(MessageWrapper : Capnp.RPC.S) = struct
  ...
  module Builder = struct
    ...
    module Decl = struct
      ...
      let union_not_initialized_get x = ()
      let union_not_initialized_set x =
        BA_.set_void ~discr:{BA_.Discr.value=0; BA_.Discr.byte_ofs=2} x
      let has_ann x =
        BA_.has_field x 0
      let ann_get x =
        BA_.get_text ~default:"" x 0
      let ann_set x v =
        BA_.set_text ~discr:{BA_.Discr.value=1; BA_.Discr.byte_ofs=2} x 0 v
      let empty_get x = ()
      let empty_set x =
        BA_.set_void ~discr:{BA_.Discr.value=2; BA_.Discr.byte_ofs=2} x
      let has_var x =
        BA_.has_field x 0
      let var_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:3 x 0
      let var_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=3; BA_.Discr.byte_ofs=2} x 0 v
      let var_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=3; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let var_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=3; BA_.Discr.byte_ofs=2} x 0
      let has_function x =
        BA_.has_field x 0
      let function_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:5 x 0
      let function_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:5 ~discr:{BA_.Discr.value=4; BA_.Discr.byte_ofs=2} x 0 v
      let function_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:5 ~discr:{BA_.Discr.value=4; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let function_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:5 ~discr:{BA_.Discr.value=4; BA_.Discr.byte_ofs=2} x 0
      let has_field x =
        BA_.has_field x 0
      let field_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:3 x 0
      let field_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=5; BA_.Discr.byte_ofs=2} x 0 v
      let field_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=5; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let field_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=5; BA_.Discr.byte_ofs=2} x 0
      let has_record x =
        BA_.has_field x 0
      let record_get x =
        BA_.get_struct ~data_words:1 ~pointer_words:2 x 0
      let record_set_reader x v =
        BA_.set_struct ~data_words:1 ~pointer_words:2 ~discr:{BA_.Discr.value=6; BA_.Discr.byte_ofs=2} x 0 v
      let record_set_builder x v =
        BA_.set_struct ~data_words:1 ~pointer_words:2 ~discr:{BA_.Discr.value=6; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let record_init x =
        BA_.init_struct ~data_words:1 ~pointer_words:2 ~discr:{BA_.Discr.value=6; BA_.Discr.byte_ofs=2} x 0
      let has_method x =
        BA_.has_field x 0
      let method_get x =
        BA_.get_struct ~data_words:1 ~pointer_words:3 x 0
      let method_set_reader x v =
        BA_.set_struct ~data_words:1 ~pointer_words:3 ~discr:{BA_.Discr.value=7; BA_.Discr.byte_ofs=2} x 0 v
      let method_set_builder x v =
        BA_.set_struct ~data_words:1 ~pointer_words:3 ~discr:{BA_.Discr.value=7; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let method_init x =
        BA_.init_struct ~data_words:1 ~pointer_words:3 ~discr:{BA_.Discr.value=7; BA_.Discr.byte_ofs=2} x 0
      let access_spec_get x = ()
      let access_spec_set x =
        BA_.set_void ~discr:{BA_.Discr.value=8; BA_.Discr.byte_ofs=2} x
      let has_ctor x =
        BA_.has_field x 0
      let ctor_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:3 x 0
      let ctor_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=9; BA_.Discr.byte_ofs=2} x 0 v
      let ctor_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=9; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let ctor_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=9; BA_.Discr.byte_ofs=2} x 0
      let has_dtor x =
        BA_.has_field x 0
      let dtor_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:2 x 0
      let dtor_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=10; BA_.Discr.byte_ofs=2} x 0 v
      let dtor_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=10; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let dtor_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=10; BA_.Discr.byte_ofs=2} x 0
      let has_typedef x =
        BA_.has_field x 0
      let typedef_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:2 x 0
      let typedef_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=11; BA_.Discr.byte_ofs=2} x 0 v
      let typedef_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=11; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let typedef_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=11; BA_.Discr.byte_ofs=2} x 0
      let has_enum_decl x =
        BA_.has_field x 0
      let enum_decl_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:2 x 0
      let enum_decl_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=12; BA_.Discr.byte_ofs=2} x 0 v
      let enum_decl_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=12; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let enum_decl_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=12; BA_.Discr.byte_ofs=2} x 0
      let has_namespace x =
        BA_.has_field x 0
      let namespace_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:2 x 0
      let namespace_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=13; BA_.Discr.byte_ofs=2} x 0 v
      let namespace_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=13; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let namespace_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:2 ~discr:{BA_.Discr.value=13; BA_.Discr.byte_ofs=2} x 0
      let has_function_template x =
        BA_.has_field x 0
      let function_template_get x =
        BA_.get_struct ~data_words:0 ~pointer_words:3 x 0
      let function_template_set_reader x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=14; BA_.Discr.byte_ofs=2} x 0 v
      let function_template_set_builder x v =
        BA_.set_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=14; BA_.Discr.byte_ofs=2} x 0 (Some v)
      let function_template_init x =
        BA_.init_struct ~data_words:0 ~pointer_words:3 ~discr:{BA_.Discr.value=14; BA_.Discr.byte_ofs=2} x 0
      type unnamed_union_t =
        | UnionNotInitialized
        | Ann of string
        | Empty
