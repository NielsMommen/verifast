              ...
              match try_assoc path !headermap with
                ...
                let (headers', ds) =
                  ...
                  | Java ->
                    ...
                    let ds = Java_fe.Frontend_bridge.parse_java_files (List.map (fun javaspec -> concat pathDir javaspec) javaspecs) [] 
          ...
          | Java -> begin
            ...
            match try_assoc rtpath !headermap with
              | None -> 
                ...
                let ds = Java_fe.Frontend_bridge.parse_java_files (List.map (fun x -> concat rtdir x) javaspecs) [] reportRange
                ...
                let prelude_name, parse_header_file = 
                  ...
                  | Some Cxx -> 
                    "prelude_cxx.h", fun report_macro_call path report_range report_should_fail verbose include_paths define_macros enforce_annotations data_model -> 
                      let module Translator = Cxx_fe.Ast_translator.Make(
                        struct 
                      ...
                      with
                      | Cxx_fe.Annotation_parser.CxxAnnParseException (l, msg)
                      | Cxx_fe.Ast_translator.CxxAstTranslException (l, msg) -> static_error l msg None
                      end
